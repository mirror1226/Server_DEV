...
//		System.out.println("content:" + content);
	...
	private String ExecPlayerCtlFriend (String type, String content)
	{
	   ...
	   //拒绝添加好友
		case "13" :
			...
			return playerOperate.RefForFriend(gameName, playerNameReq, playerNameRec)+"";
	   ...
	   //玩家选中好友进行游戏
		...
		case "16" :
			...
			return playerOperate.SearchByID(gameName, playerName, keyword);
	...
	private String ExecPlayerCtlLocation (String type, String content)
	{
		...
		//玩家搜索周边在线玩家
		case "22" :
			return playerOperate.SearchNearby(gameName, playerName, Double.valueOf(latitude), Double.valueOf(longtitude));
